...
class Layers_Customizer {
	...
	*/
	public function admin_enqueue_scripts(){
		...
		wp_enqueue_script(
			...
			LAYERS_TEMPLATE_URI . 'assets/admin/js/customizer.js' ,
			array(
				'backbone',
				'jquery',
				'wp-color-picker'
	...
	*/
	public function customizer_preview_enqueue_scripts(){
		...
		wp_enqueue_script(
			...
			LAYERS_TEMPLATE_URI . 'assets/admin/js/customizer-preview.js',
			array(
				'jquery',
			),
			LAYERS_VERSION
	...
	*/
	public function admin_print_styles(){
		...
		wp_register_style(
			LAYERS_THEME_SLUG . '-admin-customizer',
			LAYERS_TEMPLATE_URI . 'assets/admin/css/customizer.css',
			array(),
			LAYERS_VERSION
		);
