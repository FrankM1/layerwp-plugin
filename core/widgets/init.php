	...
	*/
	...
	public function admin_enqueue_scripts(){
		...
		wp_register_script(
			...
			LAYERS_TEMPLATE_URI . 'assets/admin/js/slider.js' ,
			array(),
			LAYERS_VERSION,
			true
		);
		...
		wp_register_script(
			...
			LAYERS_TEMPLATE_URI . 'assets/admin/js/content.js' ,
			array(),
			LAYERS_VERSION,
			true
		);
		...
		wp_register_script(
			...
			LAYERS_TEMPLATE_URI . 'assets/admin/js/tinymce.js' ,
			array(
				'editor',
				'word-count',
				'quicktags',
		...
		wp_enqueue_script(
			...
			LAYERS_TEMPLATE_URI . 'assets/admin/js/widget-accordians.js' ,
			array(
				LAYERS_THEME_SLUG . '-admin-slider-widget',
				LAYERS_THEME_SLUG . '-admin-content-widget',
				'backbone',
