...
class LayerWP_Template {
    ...
    public function __construct() {
		...
		$this->page_template_path = apply_filters('layerwp_view_page_template_path', plugin_dir_path( dirname(dirname(__FILE__) ) ) . 'template/');
    ...
    public static function get_instance() {
        ...
        if( null == self::$instance )
            self::$instance = new LayerWP_Template();
